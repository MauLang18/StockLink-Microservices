namespace StockLink.Softland.Utilities.Constants
{
    public class GlobalMessage
    {
        ...
        public const string MESSAGE_EXCEPTION = "Hubo un error inesperado, comunicarse con el desarrollador (mlang@grupostedi.com).";
    }
}