...
using ValidationException = StockLink.Compra.Application.UseCase.Commons.Exceptions.ValidationException;

namespace StockLink.Compra.Application.UseCase.Commons.Behaviours
{
